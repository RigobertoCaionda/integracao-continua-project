...
# A partir do momento que vc cria a regra que não se pode dar um push diretamente numa branch, ela começa a dar erro se você tentar dar push, um erro assim:  ! [remote rejected] develop -> develop (protected branch hook declined)